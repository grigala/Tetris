...
public class TileView extends View{
    ...
    public void resetTiles(int tilecount) {
        ...
        mNextTetrisArr = new Bitmap[MainMap.I_TYPE+1];
    }
    ...
    public void loadNextTetr(int key, Drawable Tetris) {
        Bitmap bitmap = Bitmap.createBitmap(90, 90, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitmap);
        Tetris.setBounds(0, 0, 90, 90);
        Tetris.draw(canvas);
        mNextTetrisArr[key] = bitmap;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(mNextTetrisArr[mCurNext], 370, 140, mPaint);
    }
}
